 ...
 *
 */
public class AmazonSESServiceImpl extends HttpServlet {
	...
	static final String FROM = ""; // Replace with your "From" address. This
									// address must be verified.
	static final String TO = ""; // Replace with a "To" address. If your account
									// is still in the
