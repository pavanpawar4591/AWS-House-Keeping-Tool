				...
				<div class="navbar-content">
					...
					<div class="main-navigation left-wrapper transition-left">
						...
						<ul class="main-navigation-menu">
							...
							<li>
								<a href="javascript:void(0)"><i class="fa fa-user"></i> <span class="title">User Management</span><i class="icon-arrow"></i> </a>
								<ul class="sub-menu">
									<li>
										<a href="#">
								...
								<li>
								<a href="#"><i class="fa fa-map-marker"></i> <span class="title">Buget</span> </a>
							</li>
							<li>
								<a href="#"><i class="fa fa-bar-chart-o"></i> <span class="title">Bill</span> </a>
							</li>
						</ul>
