...
<head>
	<title>AWS house keeping tool</title>
	<!-- start: META -->
	<meta charset="utf-8" />
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-4">
					...
					<address class="margin-bottom-40">
						Peter Clark
						<br> 12345 Street Name, City Name, United States
						<br> P: (641)-734-4763
						<br> Email:
						<a href="#">
			...
			<div class="navbar-content">
				...
				<div class="main-navigation left-wrapper transition-left">
					...
					<ul class="main-navigation-menu">
						...
						<li>
							<a href="usermanagement.html"><i class="fa fa-user"></i> <span class="title">User Management</span><i class="icon-arrow"></i> </a>

						</li>
						<li>
							<a href="awsAccounts.html"><i class="fa fa-map-marker"></i> <span class="title">AWS Accounts Management</span> </a>


						</li>
						</li>
						<li>
							<a href="Budget.html"><i class="fa fa-map-marker"></i> <span class="title">Buget</span> </a>


						</li>
						<li>
							<a href="bollingDashboard.html"><i class="fa fa-bar-chart-o"></i> <span class="title">Billing Dashbord</span> </a>
						</li>
						<li>
							<a href="#"><i class="fa fa-bar-chart-o"></i> <span class="title">Reposts</span> </a>
							<ul class="sub-menu">
								<li>
									<a href="reportUSerLogin.html">
										<span class="title"> Users Login </span>
									</a>
								</li>
								<li>
									<a href="reportSendEmail.html">
										<span class="title"> Sent Email </span>
									</a>
								</li>
								<li>
									<a href="repotAllReport.html">
										<span class="title"> *All Alerts   </span>
									</a>
								</li>
					...
					<div class="toolbar row">
						<div class="col-sm-6 hidden-xs">
							<div class="page-header">
								<h1>User Management <small> Create ,Edit and Deactivete User &amp; layouts </small></h1>
							</div>
						</div>
						...
						<div class="col-sm-12">
							...
							<div class="panel panel-white">
								<div class="panel-heading">
									<h4 class="panel-title">All Admin users <span class="text-bold"></span></h4>
...
function openWin() {
    window.open("AddNewUSer.html");
									...
									<button type="button" class="btn btn-blue" onclick="openWin()">
											Add New User
											</button>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>AWs Account</th>
												<th class="hidden-xs">Last Login Time</th>
												<th></th>
											</tr>
										</thead>
										<tbody>
											<tr>
												...
												<td class="hidden-xs">2017-01-11 10:30</td>
												<td class="center">
											...
											<tr>
												...
												<td class="hidden-xs">Microsoft@gmail.com</td>
												<td>
													<a href="#" rel="nofollow" target="_blank">
														Proprietary
													</a></td>
												<td class="hidden-xs">2017-11-22 06:30</td>
												<td class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="#" class="btn btn-xs btn-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
														<a href="#" class="btn btn-xs btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
											...
											<tr>
												...
												<td class="hidden-xs">MozillaFoundation@gmail.com</td>
												<td>
													<a href="#" rel="nofollow" target="_blank">
														MPR
													</a></td>
												<td class="hidden-xs">2016-05-04 11:11</td>
												<td class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="#" class="btn btn-xs btn-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
														<a href="#" class="btn btn-xs btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
											...
											<tr>
												...
												<td>Safari</td>
												<td class="hidden-xs">Apple@gmailc.com</td>
												<td>
													<a href="#" rel="nofollow" target="_blank">
														Proprietary
													</a></td>
												<td class="hidden-xs">2017-11-2015 00:00</td>
												<td class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="#" class="btn btn-xs btn-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
															<a href="#" class="btn btn-xs btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
											...
											<tr>
												...
												<td>Opera</td>
												<td class="hidden-xs">OperaSoftware@gmail.com</td>
												<td>
													<a href="#" rel="nofollow" target="_blank">
														Proprietary
													</a></td>
												<td class="hidden-xs">2017-11-20 06:66</td>
												<td class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="#" class="btn btn-xs btn-blue tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
														<a href="#" class="btn btn-xs btn-red tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>
				...
				<div class="panel panel-note">
					<div class="e-slider owl-carousel owl-theme">
						<div class="item">
							...
							<div class="panel-body">
								...
								<div class="note-content">
									Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut
									enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. Quis aute
									iure reprehenderit in <strong>voluptate velit</strong> esse cillum dolore eu fugiat nulla pariatur.
									<br> Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
									<br> Nemo enim ipsam voluptatem, quia voluptas sit, aspernatur aut odit aut fugit, sed quia consequuntur magni dolores
									eos, qui ratione voluptatem sequi nesciunt, neque porro quisquam est, qui dolorem ipsum, quia dolor sit, amet, consectetur,
									adipisci v'elit, sed quia non numquam eius modi tempora incidunt, ut labore et dolore magnam aliquam quaerat voluptatem.
									...
									<br> Quis autem vel eum iure reprehenderit, qui in ea voluptate velit esse, quam nihil molestiae consequatur, vel
									illum, qui dolorem eum fugiat, quo voluptas nulla pariatur?
									<br> At vero eos et accusamus et iusto odio dignissimos ducimus, qui blanditiis praesentium voluptatum deleniti
									atque corrupti, quos dolores et quas molestias excepturi sint, obcaecati cupiditate non provident, similique sunt
									...
									<br> Nam libero tempore, cum soluta nobis est eligendi optio, cumque nihil impedit, quo minus id, quod maxime placeat,
									...
									<br> Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur
									aut perferendis doloribus asperiores repellat.
								</div>
								<div class="note-options pull-right">
									<a href="#readNote" class="read-note"><i class="fa fa-chevron-circle-right"></i> Read</a>
									<a href="#" class="delete-note"><i class="fa fa-times"></i> Delete</a>
								</div>
							</div>
						...
						<div class="item">
							...
							<div class="panel-body">
								<div class="note-short-content">
									Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Nemo enim
								...
								<div class="note-options pull-right">
									<a href="#" class="read-note"><i class="fa fa-chevron-circle-right"></i> Read</a>
									<a href="#" class="delete-note"><i class="fa fa-times"></i> Delete</a>
								</div>
							</div>
							<div class="panel-footer">
